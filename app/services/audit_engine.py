...
RULE_PROFILE_MAP.update({
    "WEAK_HASH_CRC32_SECURITY": {
        "owasp_category": "A02 Cryptographic Failures",
        "nist_control": "SC-13",
        "cwe_ids": ["CWE-327"],
        "mitre_technique": "T1027",
    ...
    "WEAK_CIPHER_3DES": RULE_PROFILE_MAP["WEAK_CIPHER_DES"],
    "WEAK_CIPHER_RC4": RULE_PROFILE_MAP["WEAK_CIPHER_RC2"],
    "WEAK_CIPHER_BLOWFISH": RULE_PROFILE_MAP["WEAK_CIPHER_RC2"],
    "CBC_WITHOUT_AUTH": {
        "owasp_category": "A02 Cryptographic Failures",
        "nist_control": "SC-13",
        "cwe_ids": ["CWE-327", "CWE-353"],
        "mitre_technique": "T1573",
        "cis_control": "3.4",
    },
    "WEAK_JWT_SECRET": {
        "owasp_category": "A07 Identification and Authentication Failures",
        "nist_control": "IA-5",
        "cwe_ids": ["CWE-326", "CWE-798"],
        "mitre_technique": "T1552",
        "cis_control": "3.5",
    },
    "CONFIG_STORED_SECRET": RULE_PROFILE_MAP["HARDCODED_KEY"],
    "MISSING_CSP": RULE_PROFILE_MAP["NO_HSTS"],
    "WEAK_CSP": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_X_FRAME_OPTIONS": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_X_CONTENT_TYPE": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_REFERRER_POLICY": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_PERMISSIONS_POLICY": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_COEP": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_CORP": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_COOP": RULE_PROFILE_MAP["NO_HSTS"],
    "MISSING_CACHE_CONTROL": RULE_PROFILE_MAP["NO_HSTS"],
    "WEAK_CACHE_CONTROL": RULE_PROFILE_MAP["NO_HSTS"],
    "INVALID_X_FRAME_OPTIONS": RULE_PROFILE_MAP["NO_HSTS"],
})
